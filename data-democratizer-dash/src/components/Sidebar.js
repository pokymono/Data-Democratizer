...
export default function Sidebar() {
  ...
  return (
    <div className={`fixed md:relative transition-all duration-300 ease-in-out ${isCollapsed ? '-translate-x-56' : 'translate-x-0'} md:flex h-screen w-64 flex-col bg-gray-800 text-white dark:bg-gray-900 z-10`}>
      ...
      <button 
        ...
        className="absolute -right-10 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-r-md hover:bg-gray-700 focus:outline-none"
